...
$.getJSON('Database JSON/kumpulanData/homeWomen.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeTotebags.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeHoodies.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeFurniture.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeTrending.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeSaleFashion.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeSaleFurniture.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeSaleElectronic.json', function(data){
...
$.getJSON('Database JSON/kumpulanData/homeMusic.json', function(data){
