...
$.getJSON('kumpulanData/homeMen.json', function(data){
    let men = data.men;
...
$.getJSON('kumpulanData/homeWomen.json', function(data){
...
$.getJSON('kumpulanData/homeTotebags.json', function(data){
...
$.getJSON('kumpulanData/homeHoodies.json', function(data){
...
$.getJSON('kumpulanData/homeFurniture.json', function(data){
...
$.getJSON('kumpulanData/homeTechNews.json', function(data){
...
$.getJSON('kumpulanData/homeTrending.json', function(data){
...
$.getJSON('kumpulanData/homeSaleFashion.json', function(data){
...
$.getJSON('kumpulanData/homeSaleFurniture.json', function(data){
...
$.getJSON('kumpulanData/homeSaleElectronic.json', function(data){
...
$.getJSON('kumpulanData/homeMusic.json', function(data){
